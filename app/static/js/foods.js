$(function() {
    $('#groups-combo').combobox('reload', '/https://digital.spmi.ru/mining_foods/api/v1/groups_all');
});
          ...
          var dgterminals = $('#dg-terminals').datagrid({
                ...
                onExpandRow: function(index,row){
                    ...
                    ddv.datagrid({
                        url:'https://digital.spmi.ru/mining_foods/api/v1/logs?terminal_id='+row.terminal_id,
                        fitColumns:true,
                        singleSelect:true,
                        rownumbers:true,
                        remoteFilter: true,
...
function clientLogs(){
    var row = $('#dg').datagrid('getSelected');
     $('#client-logs').dialog('open').dialog('center').dialog('setTitle', 'Статистика: '+row.client_name);
        $('#logs').datagrid({url:'https://digital.spmi.ru/mining_foods/api/v1/logs?client_id='+row.client_id});
...
function newUser() {
    ...
    $('#fm').form('clear');
     $('#groups-combo').combobox('reload', '/https://digital.spmi.ru/mining_foods/api/v1/groups_all');
    url = '/https://digital.spmi.ru/mining_foods/api/v1/client';
    type = 'POST';
}
...
function editUser() {
    ...
    if (row) {
        ...
        $('#fm').form('load', row);
        url = '/https://digital.spmi.ru/mining_foods/api/v1/client/' + row.client_id;
        type = 'PUT';
...
function blockUser() {
    var row = $('#dg').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/block_client";
    if (row) {
...
function activateUser() {
     ...
     var row = $('#dg').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/activate_client";
    if (row) {
...
function destroyUser() {
    var row = $('#dg').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/client";
    if (row) {
...
function newAccount() {
    ...
    $('#fm-users').form('clear');
    url = '/https://digital.spmi.ru/mining_foods/api/v1/new_user';
    type = 'POST';
}

function blockAccount() {
     var row = $('#dg-users').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/block_user";
    if (row) {
...
function deleteAccount(){
    var row = $('#dg-users').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/users";
    if (row) {
...
function editAccount() {
    ...
    if (row) {
        ...
        url = '/https://digital.spmi.ru/mining_foods/api/v1/users/' + row.user_id;
        type = 'PUT';
...
function activateAccount() {
     var row = $('#dg-users').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/activate_user";
    if (row) {
...
function blockTerminal() {
    ...
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/block_terminal";
    if (row) {
...
function activateTerminal() {
    var row = $('#dg-terminals').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/activate_terminal";
    if (row) {
...
function deleteTerminal() {
    var row = $('#dg-terminals').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/delete_terminal";
    if (row) {
...
function editTerminal() {
    ...
    if (row) {
        ...
        url = '/https://digital.spmi.ru/mining_foods/api/v1/terminals/'+ row.terminal_id;
...
function newGroup() {
    ...
    url = '/https://digital.spmi.ru/mining_foods/api/v1/new_group';
    type = 'POST';
}

function blockGroup() {
     var row = $('#dg-groups').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/block_group";
    if (row) {
...
function activateGroup() {
     var row = $('#dg-groups').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/activate_group";
    if (row) {
...
function deleteGroup(){
    var row = $('#dg-groups').datagrid('getSelected');
    var url = "/https://digital.spmi.ru/mining_foods/api/v1/delete_group";
    if (row) {
...
function editGroup() {
    ...
    if (row) {
        ...
        url = '/https://digital.spmi.ru/mining_foods/api/v1/groups/' + row.group_id;
        type = 'PUT';
